...
Item {
    ...
    SequentialAnimation {
        ...
        SequentialAnimation {
            ...
            ScriptAction {
                script: {
                    ...
                    levelName.y -= mainHero.moveV * 1.5
                }
            }
            PauseAnimation {
                duration: 320
        ...
        ScriptAction {
            script: {
                ...
                way.y = 0.78 * pageLoader.height - way.height + (3 - 2) * (levelName.height / 1.44)
            }
        }
        PauseAnimation {
            duration: 200
    ...
    SequentialAnimation {
        ...
        ScriptAction {
            script: {
                image_front.opacity = 1
                way.y = 0.78 * pageLoader.height - way.height + (3 - 3) * (levelName.height / 1.44)
            }
        }
        PauseAnimation {
            duration: 200
    ...
    SequentialAnimation {
        ...
        ScriptAction {
            script: {
                image_front.opacity = 1
                way.y = 0.78 * pageLoader.height - way.height + (3 - 1) * (levelName.height / 1.44)
            }
        }
        PauseAnimation {
            duration: 200
